...
```{r}
perm_test(r_labels=true_labels, c_labels=c1_labels, coords=coords, use_parallel=FALSE)
perm_test(r_labels=true_labels, c_labels=c2_labels, coords=coords, use_parallel=FALSE)
```
