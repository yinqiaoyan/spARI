...
**Remark3.** For object pairs whose distances are not stored in the sparse matrix, their weights are set to one if they form an agreement pair and zero if they form a disagreement pair.
